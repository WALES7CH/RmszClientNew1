package com.rmsz.rmszclient.Utils;
...
public class TokenSaveUtil {
    private final static String FILENAME = "login_token";
     ...
     * @return modified:
     */
    public static Object readToken(Context context) {
        try {
