...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.login_et_username);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.login_btn_signin);
...
//                attemptLogin();
        ...
        mProgressView = findViewById(R.id.login_pb_progress);
    }
...
//                                Log.e(TAG, "token_str::" + token_str);
                                SPUtils.put(context,BaseInfo.SHARE_KEY_TOKEN,token_str);
                                SPUtils.put(context,BaseInfo.SHARE_KEY_USERNAME,email);
                                SPUtils.put(context,BaseInfo.SHARE_KEY_PASSWORD, MD5Util.MD5(password));
                            ...
                            case 403:
                                ...
                                break;
                            default:
                                T.showShort(LoginActivity.this,"未知错误");
                                break;
                        }
                    }
                });
